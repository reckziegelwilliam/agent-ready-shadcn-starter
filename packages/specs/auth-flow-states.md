...
| **Error (network)** | No connectivity / API unreachable | Amber banner with WiFi icon, distinct message, and retry button | Fetch error caught in thunk, distinct "Unable to connect" message, dedicated UI treatment in form | Done |
...
| **Error (network)** | No connectivity | Amber banner with WiFi icon, distinct message, and retry button | Fetch error caught in thunk, distinct "Unable to connect" message, dedicated UI treatment in form | Done |
...
|-----|-----------------|----------|-------|
| Offline/network error handling | All 3 | Medium | Implemented via fetch error detection in thunks + distinct amber UI in forms |
